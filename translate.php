...
foreach ($file as $k=>$v){
    ...
    $rst[$k]=Translate::exec ( $v,'zh','en');
}

// $a=file_put_contents('123.php', $rst);

//echo Translate::exec ( "你好世界！" );
...
if(false!==fopen($put_file,'w+')){
  file_put_contents($put_file,$text);
}else{
  echo '创建失败';
}